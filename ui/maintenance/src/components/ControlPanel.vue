  ...
  <div class="row">
    <!-- LEFT PANEL-->
      ...
      <div class="d-flex flex-column col-lg-4 align-items-center justify-content-start">
        ...
        <!-- ONLY IN MAINTENANCE UI -->
         <div class="d-flex flex-row">
           <button id="pump-fill-button" class="button-lg button-primary mt-lg-3 mb-lg-3" aria-label="run pump fill command" @click="sendCommandPumpIn">FILL</button>
        <button id="pump-empty-button" class="button-lg button-warning mt-lg-3 mb-lg-3" aria-label="run pump empty command" @click="sendCommandPumpOut">EMPTY</button>
        <button id="pump-stop-button" class="button-lg button-danger mt-lg-3 mb-lg-3" aria-label="run pump stop command" @click="sendCommandPumpStop">STOP</button>
